...
legend('$\tau=0.1$','$\tau=0.2$','$\tau=0.3$','$\tau=0.5$','$\tau=1.0$','interpreter','latex',...
    'location','northwest','fontsize',16);
xlabel('$\mathbf{z}_{i}^{\top} \mathbf{z}_{l}$','interpreter','latex','fontsize',16);
ylabel('$g(\mathbf{z}_{i}^{\top} \mathbf{z}_{l}; \tau)$','interpreter','latex','fontsize',16);
ylim([0.0, 0.5]);hold off;
